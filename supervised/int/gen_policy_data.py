...
def problem_to_policy_data_points(problem_with_final_statement,
    ...
    if n_samples_per_proof is not None:
        # print(n_samples_per_proof)
        # print(f"state_destination_action_data:{len(state_destination_action_data)}")
        # print(f"state_destination_action_data:{state_destination_action_data}")
